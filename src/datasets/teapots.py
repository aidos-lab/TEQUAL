...
class TeaPotsDataModule(DataModule):
    ...
    def setup(self):
        ...
        self.file = os.path.join(self.dataset_folder_name, "TeaPots.npz")
        if not os.path.isfile(self.file):
            self.generate()
        self.train_ds = TeaPots(self.file)
        self.val_ds = TeaPots(self.file)
        self.test_ds = TeaPots(self.file)
...
def initialize():
    register("dataset", TeaPotsDataModule)
