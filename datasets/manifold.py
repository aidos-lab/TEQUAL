...
class ManifoldDataModule(DataModule):
    ...
    def prepare_data(self):
        self.train_ds = ManifoldDataset(self.config, split="train", pre_transform=self.transform)
        self.test_ds = ManifoldDataset(self.config, split="test", pre_transform=self.transform)
        self.val_ds = ManifoldDataset(self.config, split="val", pre_transform=self.transform)
        self.entire_ds = ManifoldDataset(self.config, split="train", pre_transform=self.transform)
